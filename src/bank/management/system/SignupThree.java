    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(accountType.equals("")){
                ...
                JOptionPane.showMessageDialog(null,"Service is Required");
            }else if ( !c7.isSelected()){
            JOptionPane.showMessageDialog(null, "Please check all the required boxes", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
                Conn conn = new Conn();
                ...
                setVisible(false);
                new Mandatorydeposit(pinnumber).setVisible(true);                
