...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        small = new JLabel("Form No: " + formno);
        small.setFont(new Font("Raleway",Font.BOLD,16));
        small.setBounds(650,20,600,40);
        add(small);
        ...
        String occupationValues[]={"","Working","Self-Employed","Business","Student","Retired","Others"};
        ...
        try{
            if(sreligion.equals("")){
                ...
                JOptionPane.showMessageDialog(null,"Pan Number is Required");
                            ...
                            JOptionPane.showMessageDialog(null, "Please enter a valid Pan Number \nExample: ABCDE1234A", "Error", JOptionPane.ERROR_MESSAGE);
            }else if(saadhar.equals("")){
                JOptionPane.showMessageDialog(null,"Aadhar number is Required");
            }else if (!(saadhar.matches("\\d{12}"))){
                            JOptionPane.showMessageDialog(null, "Please enter a valid 12 Digit Aadhar Number", "Error", JOptionPane.ERROR_MESSAGE);
            }else if(seniorcitizen.equals("")){
                JOptionPane.showMessageDialog(null,"Check the Form again. \nSome option is not selected");
